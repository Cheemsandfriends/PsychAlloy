...
class FlxFilteredSprite extends FlxSprite
{
	...
	override function drawComplex(camera:FlxCamera):Void
	{
		...
		camera.drawPixels((_blankFrame == null) ? _frame : _blankFrame, framePixels, _matrix, colorTransform, blend, antialiasing, shader);
	}
...
// A fork from the normal filter renderer to support spritesheet animation bleh
@:noCompletion
